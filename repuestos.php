        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <span class="btn btn-warning" style="float: right;" data-toggle="modal" data-target="#agregarnuevosdatosmodal">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Agrega nuevos repuestos</h5>
                              ...
                              <div class="modal-body">
                                <form id="frmnuevo">
                                    ...
                                    <input type="number" class="form-control input-group-sm" id="cantidad" name="cantidad" min="0">
                                </form>
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                <button type="button" id="btnAgregarnuevo" class="btn btn-warning">Agregar nuevo</button>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Actualizar repuestos</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                <form id="frmnuevoU">
                                    ...
                                    <label for="">Cantidad</label>
                                    <input type="number" class="form-control input-group-sm" id="cantidadU" name="cantidadU" min="0">
                                </form>
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    function agregaFrmActualizar(idjuego){
        $.ajax({
              ...
              success:function(r){
                ...
                $('#idjuego').val(datos['id_repuestos']);

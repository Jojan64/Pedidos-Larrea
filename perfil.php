...
<head>
    ...
    <title>Perfil - IMPORTCAR ADMIN</title>
    <!-- ===== Bootstrap CSS ===== -->
                    ...
                    <div class="dropdown user-pro-body">
                        <div class="profile-image">
                            ...
                            <ul class="dropdown-menu animated flipInY">
                                ...
                                <li role="separator" class="divider"></li>
                                <li><a href="cerrarsesion.php"><i class="fa fa-power-off"></i> Logout</a></li>
                            </ul>
                        </div>
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title"><?php echo "$email"; ?> </h3> </div>
            ...
            <!-- /.container-fluid -->
            <footer class="footer t-a-c"> © 2020 Cubic Admin
            </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
